...
from backend.schemas.projection import BudgetVsActualResponse, ProjectionResponse
from backend.services.calculations import compute_budget_vs_actual, compute_projection
...
def get_budget_vs_actual(
    ...
    rows = compute_budget_vs_actual(session, start_year=start_year, years=years, initial_cash=initial_cash)
    return BudgetVsActualResponse(rows=rows, metadata={"start_year": str(start_year), "years": str(years)})
